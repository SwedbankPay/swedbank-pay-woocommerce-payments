...
class WC_SB_Payee_Reference
{
	public function __construct() {
		add_filter( 'sb_get_payee_reference' , array( $this, 'get_payee_reference' ), 10, 3 );
		add_filter( 'sb_get_payee_reference_order' , array( $this, 'get_orderid_by_payee_reference' ), 10, 2 );
	}
