...
class WC_Gateway_Payex_Psp_Swish extends WC_Gateway_Payex_Cc
	...
	public function __construct() {
		...
		$this->method_title = __( 'Swish', WC_Payex_Psp::TEXT_DOMAIN );
		...
		add_filter( 'payex_swish_phone_format', array( $this, 'swish_phone_format' ), 10, 2 );
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Swish payment', WC_Payex_Psp::TEXT_DOMAIN )
			),
			'description'    => array(
			...
			'method'         => array(
				'title'       => __( 'Checkout Method', WC_Payex_Psp::TEXT_DOMAIN ),
				'type'        => 'select',
				'options'     => array(
					'redirect' => __( 'Redirect', WC_Payex_Psp::TEXT_DOMAIN ),
					'direct'   => __( 'Direct', WC_Payex_Psp::TEXT_DOMAIN ),
				),
				'description' => __( 'Checkout Method', WC_Payex_Psp::TEXT_DOMAIN ),
				'default'     => $this->method
			),
			'ecom_only'      => array(
				'title'   => __( 'Ecom Only', WC_Payex_Psp::TEXT_DOMAIN ),
				'type'    => 'checkbox',
				'label'   => __( 'Enable logging', WC_Payex_Psp::TEXT_DOMAIN ),
	...
	public function validate_fields() {
		...
		if ( ! isset( $matches[0] ) || $matches[0] !== $billing_phone ) {
			wc_add_notice( __( 'Input your number like this +46xxxxxxxxx', WC_Payex_Psp::TEXT_DOMAIN ), 'error' );
	...
	public function process_payment( $order_id ) {
		...
		switch ( $this->method ) {
			...
			default:
				wc_add_notice( __( 'Wrong method', WC_Payex_Psp::TEXT_DOMAIN ), 'error' );
...
// Register Gateway
WC_Payex_Psp::register_gateway( 'WC_Gateway_Payex_Psp_Swish' );
