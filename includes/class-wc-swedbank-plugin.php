...
class WC_Swedbank_Plugin {
	...
	const ADMIN_SUPPORT_PAGE_SLUG = 'swedbank-pay-payments-support';
	...
	public static function support_submit() {
		...
		if ( ! extension_loaded( 'zip' ) ) {
			$_SESSION['form_errors'] = array();
			$_SESSION['form_errors'][] = __( 'zip extension is required to perform this operation.', 'swedbank-pay-woocommerce-payments' );
		...
		if ( empty( $_POST['email'] ) || empty( $_POST['message'] ) ) {
			$_SESSION['form_errors'] = array();
			$_SESSION['form_errors'][] = __( 'Invalid form data', 'swedbank-pay-woocommerce-payments' );
		...
		if ( ! is_email( $_POST['email'] ) ) {
			$_SESSION['form_errors'] = array();
			$_SESSION['form_errors'][] = __( 'Invalid email', 'swedbank-pay-woocommerce-payments' );
		...
		if ( ! $result ) {
			$_SESSION['form_errors'] = array();
			$_SESSION['form_errors'][] = __( 'Unable to send mail message.', 'swedbank-pay-woocommerce-payments' );
		} else {
			$_SESSION['form_notices'] = array();
			$_SESSION['form_notices'][] = __( 'Your message has been sent.', 'swedbank-pay-woocommerce-payments' );
		}
