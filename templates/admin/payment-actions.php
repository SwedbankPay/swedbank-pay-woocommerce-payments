...
<div>
    ...
    <br/>
    <strong><?php _e( 'Number', WC_Swedbank_Pay::TEXT_DOMAIN ) ?>
        :</strong> <?php echo esc_html( $info['payment']['number'] ); ?>
    <br/>
    <strong><?php _e( 'Instrument', WC_Swedbank_Pay::TEXT_DOMAIN ) ?>
        : </strong> <?php echo esc_html( $info['payment']['instrument'] ); ?>
    <br/>
    <strong><?php _e( 'Intent', WC_Swedbank_Pay::TEXT_DOMAIN ) ?>
        : </strong> <?php echo esc_html( $info['payment']['intent'] ); ?>
    <br/>
    <strong><?php _e( 'State', WC_Swedbank_Pay::TEXT_DOMAIN ) ?>
